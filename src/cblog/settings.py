...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cdi93hyr8j0n.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'jelloulblog' # please enter your s3 bucket name
